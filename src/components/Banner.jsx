...
const Banner = () => {
  return (
     <div
      className="h-[60vh] w-full bg-cover bg-center bg-no-repeat rounded-lg shadow-2xl"
      style={{
        backgroundImage:
      ...
      <div className="w-full h-full  bg-black/60 rounded-lg flex items-center">
        <div className="max-w-7xl mx-auto px-6 text-white">
          ...
          <div className="flex gap-4 items-center justify-center flex-wrap">
            ...
            <Link href="/all-tiles">
              <button className="px-6 py-3 rounded-lg font-medium bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 hover:opacity-90 transition">
                Browse Now
              </button>
            </Link>
          </div>
